//Credits to our dearest leader: Mr. Brown!
//Original Code can be found here: https://github.com/ap251/basement/blob/master/heap/v2/Heapsort.java

/*****************************************************
 * class Heapsort  ---  v2: performs sort in-place
